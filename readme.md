...
The file ~/.docker/cli-plugins/docker-compose should be a symlink to ~/.rd/bin/docker-compose, but points to /Applications/OrbStack.app/Contents/MacOS/xbin/docker-compose
